...
import com.lld.projects.elevatorSystem.enums.DoorState;
...
public class ElevatorCar {
    ...
    public void moveElevator(int destinationFloor) {
        //this is dump object, so if command has come, to go particular direction and particular floor, it just moves
